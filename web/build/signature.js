...
/* WEBPACK VAR INJECTION */(function(jQuery) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap_sass_assets_javascripts_bootstrap__ = __webpack_require__(/*! bootstrap-sass/assets/javascripts/bootstrap */ "./node_modules/bootstrap-sass/assets/javascripts/bootstrap.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap_sass_assets_javascripts_bootstrap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_bootstrap_sass_assets_javascripts_bootstrap__);
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()(document).ready(function () {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#button-modal").click(function () {
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#myModal").modal('show');
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#myModal').on('show.bs.modal', function (e) {
            if (!data) return e.preventDefault(); // stops modal from being shown
        });
    });
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.support.transition = false;

    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('body').on('click', '.bcPaint-palette-color', function () {
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).parent().find('.selected').removeClass('selected');
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).addClass('selected');
        __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.fn.bcPaint.setColor(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).css('background-color'));
    });

    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('body').on('click', '#bcPaint-reset', function () {
        __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.fn.bcPaint.clearCanvas();
    });

    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('body').on('click', '#submit', function () {
        __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.fn.bcPaint.export();
    });

    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#canvas').bcPaint();
});
...
(function ($) {
    ...
    $.extend(true, $.fn.bcPaint, {
         ...
         */
        dispatchMouseEvent: function dispatchMouseEvent(e, mouseAction) {
    ...
    $.fn.bcPaint.defaults = {
        ...
        // default color set
        colors: ['000000', '444444', '999999', 'DDDDDD', '6B0100', 'AD0200', '6B5E00', 'FFE000', '007A22', '00E53F', '000884', '000FFF'],
